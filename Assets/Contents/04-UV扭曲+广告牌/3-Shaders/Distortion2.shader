Shader "Custom/04-Distortion/Distortion2"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    pass
    {
      ...
      real4 frag(v2f i) : SV_TARGET
      {
        ...
        real4 screenColor = SAMPLE_TEXTURE2D(_TransparentSceneColor, sampler_TransparentSceneColor, screenUV);
